...
export type GetPositionsSubscription = { __typename?: 'subscription_root', Position: Array<{ __typename?: 'Position', collateral: string, assets: string, direction: string, entryVolume: string, entryPrice: string, entryTimestamp: string, id: string }> };
